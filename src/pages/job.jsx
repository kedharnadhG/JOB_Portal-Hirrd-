...
import { Briefcase, DoorOpen, MapIcon, MapPinIcon } from "lucide-react";
  ...
  return (
    <div className="flex flex-col gap-8 mt-5">
      <div className="flex flex-col-reverse gap-6 md:flex-row  items-center justify-between ">
        <h1 className="gradient-title text-4xl pb-3 sm:text-6xl font-extrabold">
          {job?.title}
        </h1>
